...
let id : number = 5;
let firstName = "Shashwat"; // TS understands firstName will store strings
...
let data : (number | string | boolean)[] = [1, "shashwat", true];

console.log(ids, hetero, data);

// arrays in form of typed tuple
let data1 : [number , string , boolean] = [1, "shashwat", true]; 
